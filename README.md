...
<p align="center">
  ...
  <br>🎓 Выпускник <strong>Университета Zerocoding</strong>
  <br>💡 Основные профессиональные интересы в области разработки и интегрций AI, а также вайб-кодинга и автоматизациии
</p>
...
<div style="background: linear-gradient(to right, #ff7b00, #6c63ff); padding: 20px; border-radius: 20px; box-shadow: 0 6px 15px rgba(0, 0, 0, 0.1); color: white; font-family: 'Arial', sans-serif;">
  ...
  <ul style="font-size: 1.1em; list-style-type: none; padding: 0; text-align: center; color: #fff;">
    ...
    <li>Разрабатываю ботов под ключ: автоворонки, платежные системы, интеграция с БД, интеграции по API с другими сервисами, подключение ИИ, деплой на удаленном сервере, сопровождение</li>
  </ul>
...
💡 **Описание:** Телеграм-бот "Мой Рекомендатор" позволяет пользователям централизованно хранить рекомендации (фильмы, сериалы, книги, продукты, места, музыку и т.д.), полученные от друзей, из блогов, статей и т.п. Бот предоставляет удобный интерфейс для добавления, поиска, просмотра, редактирования и удаления рекомендаций, а также для получения случайной рекомендации, когда пользователь не может определиться. <br>
...
### 📌 [KvizGeoBot](https://github.com/avsolon/KvizGeoBot)
...
### 📌 [InformerBot](https://github.com/avsolon/InformerBot)
💡 **Описание:** Телеграм-бот предоставляет информацию по текщей погоде в любом городе мира по запросу. Предоставление курсов валют к рублю. Возможна любая доработка по необходимой информации.<br>
🛠️ **Технологии:** Python, PTB 3.20, API OPENWEATHER, API CBR<br>
...
✨ **Всегда открыт к новым возможностям и интересным предложениям!** 💪
